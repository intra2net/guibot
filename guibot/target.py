...
class Target(object):
    ...
    def get_center_offset(self) -> location.Location:
        """
        Getter for readonly attribute.
...
class Image(Target):
    ...
    def __init__(self, image_filename: str = None, pil_image: PIL.Image = None,
    ...
    def load(self, filename: str, use_cache: bool = True, **kwargs) -> None:
        """
    ...
    def save(self, filename: str) -> target.Image:
        """
...
class Pattern(Target):
    ...
    def __init__(self, id, match_settings: str = None) -> Finder:
        """
...
class Chain(Target):
    ...
    def load(self, steps_filename: str, **kwargs) -> None:
        """
