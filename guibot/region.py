...
class Region(object):
    ...
    def get_center(self) -> location.Location:
        """
        Getter for readonly attribute.
    ...
    def get_top_left(self) -> location.Location:
        """
        Getter for readonly attribute.
    ...
    def get_top_right(self) -> location.Location:
        """
        Getter for readonly attribute.
    ...
    def get_bottom_left(self) -> location.Location:
        """
        Getter for readonly attribute.
    ...
    def get_bottom_right(self) -> location.Location:
        """
        Getter for readonly attribute.
    ...
    def get_last_match(self) -> match.Match:
        """
        Getter for readonly attribute.
    ...
    def get_mouse_location(self) -> location.Location:
        """
        Getter for readonly attribute.
    ...
    def find(self, target: str | target.Target, timeout: int = 10) -> match.Match:
        """
    ...
    def find_all(self, target: str | target.Target, timeout: int = 10,
                 allow_zero: bool = False) -> match.Match:
        """
    ...
    def _target_from_string(self, target_str):
        ...
        #..todo:: target_str is not documented
        try:
    ...
    def _determine_cv_backend(self, target: str | target.Target):
    ...
    def sample(self, target: str | target.Target) -> float:
        """
    ...
    def exists(self, target: str | target.Target, timeout: int = 0) -> match.Match | None:
        """
    ...
    def wait(self, target: str | target.Target, timeout: int = 30) -> match.Match:
        """
    ...
    def wait_vanish(self, target: str | target.Target, timeout: int = 30) -> Region:
        """
    ...
    def hover(self, target_or_location: match.Match | location.Location | str | target.Target) -> match.Match | None:
        """
    ...
    def click(self, target_or_location: match.Match | location.Location | str | target.Target,
              modifiers: list[str] = None) -> match.Match | None:
        """
    ...
    def right_click(self, target_or_location: match.Match | location.Location | str | target.Target,
                    modifiers: list[str] = None) -> match.Match | None:
        """
    ...
    def middle_click(self, target_or_location: match.Match | location.Location | str | target.Target,
                    modifiers: list[str] = None) -> match.Match | None:
        """
    ...
    def double_click(self, target_or_location: match.Match | location.Location | str | target.Target,
                    modifiers: list[str] = None) -> match.Match | None:
        """
    ...
    def multi_click(self, target_or_location: match.Match | location.Location | str | target.Target,
                    count: int = 3, modifiers: list[str] = None) -> match.Match | None:
        """
    ...
    def click_expect(self, click_image_or_location: Image | Location,
                     expect_target: str | target.Target, modifiers: list[Key] = None,
                     timeout: int = 60, retries: int = 3) -> match.Match:
        """
    ...
    def click_vanish(self, click_image_or_location: Image or Location,
                     expect_target: str | target.Target, modifiers: list[Key] = None,
    ...
    def click_at_index(self, anchor: str | target.Target, index: int = 0,
                       find_number: int = 3, timeout: int = 10) -> match.Match:
        """
    ...
    def mouse_down(self, target_or_location: match.Match | location.Location | str | target.Target,
                   button: int = None) -> match.Match | None:
        """
    ...
    def mouse_up(self, target_or_location: match.Match | location.Location | str | target.Target,
                   button: int = None) -> match.Match | None:
        """
    ...
    def mouse_scroll(self, target_or_location: match.Match | location.Location | str | target.Target,
                     clicks: int = 10, horizontal: bool = False) -> match.Match | None:
        """
    ...
    def drag_drop(self, src_target_or_location: match.Match | location.Location | str | target.Target,
                  dst_target_or_location: match.Match | location.Location | str | target.Target,
                  modifiers: list[str] = None) -> match.Match | None:
        """
    ...
    def drag_from(self, target_or_location: match.Match | location.Location | str | target.Target,
                  modifiers: list[str] = None) -> Region:
        """
    ...
    def drop_at(self, target_or_location: match.Match | location.Location | str | target.Target,
                modifiers: list[str] = None) -> Region:
        """
    ...
    def press_expect(self, keys: list[str] | str, expect_target: str | target.Target,
                     timeout: int = 60, retries: int = 3) -> match.Match:
        """
    ...
    def press_vanish(self, keys: list[str] | str, expect_target: str | target.Target,
                     timeout: int = 60, retries: int = 3) -> Region:
        """
    ...
    def type_at(self, text: list[str] | str, target_or_location: match.Match | location.Location | str | target.Target,
                modifiers: list[str] = None) -> Region:
        """
        Type a list of consecutive character keys (without special keys)
        at a specified target or location.
    ...
    def _parse_text(self, text: list[str] | str,
                    target_or_location: match.Match | location.Location | str | target.Target = None) -> list[str]:
        at_str = " at %s" % target_or_location if target_or_location else ""
