...
class Region(object):
    ...
    def _target_from_string(self, target_str: Target) -> Target:
    ...
    def _determine_cv_backend(self, target: str | Target) -> "Match":
    ...
    def fill_at(self, anchor: "Match | Location | Target | str",
        ...
        if not text:
            return self.click_at(anchor, dx, dy, count=mark_clicks)
