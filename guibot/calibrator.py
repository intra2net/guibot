...
class Calibrator(object):
    ...
    def __init__(self, needle: target.Target = None, haystack: target.Image = None,
    ...
    def benchmark(self, finder: finder.Finder, random_starts: int = 0, uniform: bool = False,
                  calibration: bool = False, max_attempts: int = 3,
                  **kwargs) -> list[tuple[str, float, location.Location, float]]:
        """
    ...
    def search(self, finder: finder.Finder, random_starts: int = 1, uniform: bool = False,
               calibration: bool = True, max_attempts: int = 3, **kwargs) -> float:
        """
    ...
    def calibrate(self, finder: finder.Finder, max_attempts: int = 3, **kwargs) -> float:
        """
    ...
    def run_default(self, finder: finder.Finder, **_kwargs) -> float:
        """
    ...
    def run_performance(self, finder: finder.Finder, **kwargs) -> float:
        """
        Run a match case and return error from the match as dissimilarity
    ...
    def run_peak(self, finder: finder.Finder, **kwargs) -> float:
        """
    ...
    def _handle_restricted_values(self, finder: finder.Finder) -> None:
    ...
    def _prepare_params(self, finder: finder.Finder) -> None:
