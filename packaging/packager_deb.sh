...
echo "------------- contour, template, feature, cascade, matching -------------"
...
if [[ $distro_version == "xenial" ]]; then
    ...
    pip3 install pytesseract==0.3.13 tesserocr==2.7.0
fi
...
apt-get -y install python3-tk # NOTE: You must install tkinter to use MouseInfo
